...
class CourseOfferings {
  ...
  public:
	...
	CourseOfferings(const CourseOfferings& newcourse);
    /* TODO: Declare copy assignment operator function here. */
	CourseOfferings& operator=(const CourseOfferings& newcourse);
...
/* TODO: Declare CourseOfferings extraction overload operator function here. */
	std::ostream& operator<< (std::ostream& os, const CourseOfferings& newcourse);
/**
