...
int main() {
	...
	if (examCount > 0)
		exam_average = examTotal / examCount;
	...
	weighted_total += exam_average * .4;
	weighted_total += hw_average * .4;
	weighted_total += lw_average * .1;
	weighted_total += engagement * .1;
